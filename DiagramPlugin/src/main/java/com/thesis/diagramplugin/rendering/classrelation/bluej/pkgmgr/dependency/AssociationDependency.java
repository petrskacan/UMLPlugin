 ...
 */
public class AssociationDependency extends UsesDependency
{

    public AssociationDependency(Package pkg, DependentTarget from, DependentTarget to)
    {
        super(pkg, from, to);
    }

    public AssociationDependency(Package pkg)
    {
        this(pkg, null, null);
    }    
    ...
    public void save(Properties props, String prefix)
    {
        ...
        props.put(prefix + ".type", "AssociationDependency");
    }
