...
public class ClassDiagramViewProvider implements FileEditorProvider, DumbAware {

    private static final String EDITOR_TYPE_ID = "ClassDiagramView";

    @Override
    public boolean accept(@NotNull Project project, @NotNull VirtualFile file) {
        return file.getName().endsWith(DiagramConstants.XML_FILE_NAME_POSTFIX_CLASS_DIAGRAM);
    }
    ...
    FileEditor createEditor(@NotNull Project project, @NotNull VirtualFile file) {
        ...
        ClassDiagramEditor editor = null;
        try {
