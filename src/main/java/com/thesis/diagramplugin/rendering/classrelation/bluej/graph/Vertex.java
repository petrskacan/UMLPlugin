...
public abstract class Vertex implements SelectableGraphElement {
    ...
    public class VertexJComponent extends JComponent implements Accessible {
...
//            if (Vertex.this instanceof PackageTarget) {
//                PackageTargetPainter.drawShadow((Graphics2D) g, ((PackageTarget) Vertex.this).getWidth(), ((PackageTarget) Vertex.this).getHeight());
//                PackageTargetPainter.drawSkeleton((Graphics2D) g, (PackageTarget) Vertex.this, ((PackageTarget) Vertex.this).getWidth(), ((PackageTarget) Vertex.this).getHeight());
//                PackageTargetPainter.drawUMLStyle((Graphics2D) g, (PackageTarget) Vertex.this, ((PackageTarget) Vertex.this).getWidth(), ((PackageTarget) Vertex.this).getHeight(), false);
//            } else if (Vertex.this instanceof ClassTarget) {
//                ClassTargetPainter.drawShadow((Graphics2D) g, ((ClassTarget) Vertex.this).getWidth(), ((ClassTarget) Vertex.this).getHeight());
//                ClassTargetPainter.drawSkeleton((Graphics2D) g, (ClassTarget) Vertex.this, ((ClassTarget) Vertex.this).getWidth(), ((ClassTarget) Vertex.this).getHeight());
//                ClassTargetPainter.drawUMLStyle((Graphics2D) g, (ClassTarget) Vertex.this, ((ClassTarget) Vertex.this).getWidth(), ((ClassTarget) Vertex.this).getHeight(), false);
//            }
//        };
